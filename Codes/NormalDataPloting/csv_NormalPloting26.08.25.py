...
plt.plot(x, y4, label='115', color='pink', linestyle='-', marker='o', markersize=4)
plt.plot(x, y5, label='119', color='orange', linestyle='-', marker='o', markersize=4)
plt.plot(x, y6, label='121', color='purple', linestyle='-', marker='o', markersize=4)
plt.plot(x, y7, label='148', color='brown', linestyle='-', marker='o', markersize=4)
plt.plot(x, y8, label='177', color='cyan', linestyle='-', marker='o', markersize=4)
plt.plot(x, y9, label='343', color='magenta', linestyle='-', marker='o', markersize=4)
plt.plot(x, y10, label='484', color='yellow', linestyle='-', marker='o', markersize=4)
